...
export const Background = () => {
  ...
  return (
    <BackContainer>
      <Typo size="35px">
        나눔의 소중한 예를 보여주신 <OrangeTypo>기부자들</OrangeTypo>
      </Typo>
      <ImageGroup>
        <ImageTextGroup>
      ...
      <Back>
        <Typo size="15px" left="90px" top="-3px">
          순위
        </Typo>
        <Typo size="15px" left="230px" top="-3px">
          닉네임
        </Typo>
        <Typo size="15px" left="310px" top="-3px">
          주요 기부처
        </Typo>
        <Typo size="15px" left="170px" top="-3px">
          총기부금액{" "}
        </Typo>
        <Typo size="15px" left="160px" top="-3px">
          기부횟수
        </Typo>
      </Back>
      {currentGroup === "group1" && (
        <>
          <PersonContainer>
            ...
            <Typo size="22px" left="60px" top="-3px">
              의료|복지
            </Typo>
            <Typo size="23px" left="130px" top="-3px">
              13,200,000원
            </Typo>
            <Typo size="23px" left="130px" top="-3px">
              8회
          ...
          <PersonContainer>
            ...
            <Typo size="22px" left="63px" top="-3px">
              결손가정
            </Typo>
            <Typo size="23px" left="134px" top="-3px">
              10,000,000원
            </Typo>
            <Typo size="23px" left="130px" top="-3px">
              1회
          ...
          <PersonContainer>
            ...
            <Typo size="23px" left="142px" top="-3px">
              7,371,000원
            </Typo>
            <Typo size="23px" left="135px" top="-3px">
              7회
            </Typo>
          </PersonContainer>
          <PersonContainer>
            ...
            <Typo size="22px" left="44px" top="-3px">
              소년소녀가장
            </Typo>
            <Typo size="23px" left="120px" top="-3px">
              5,130,000원
            </Typo>
            <Typo size="23px" left="135px" top="-3px">
              6회
          ...
          <PersonContainer>
            ...
            <Typo size="23px" left="143px" top="-3px">
              4,192,000원
            </Typo>
            <Typo size="23px" left="135px" top="-3px">
              6회
          ...
          <PersonContainer>
            ...
            <Typo size="23px" left="139px" top="-3px">
              4,000,000원
            </Typo>
            <Typo size="23px" left="135px" top="-3px">
              2회
      ...
      {currentGroup === "group2" && (
        <>
          ...
          <PersonContainer>
            ...
            <Typo size="22px" left="50px" top="-3px">
              재난구호
            </Typo>
            <Typo size="23px" left="140px" top="-3px">
              3,000,000원
            </Typo>
            <Typo size="23px" left="135px" top="-3px">
              5회
